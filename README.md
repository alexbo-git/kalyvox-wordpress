...
- WordPress-native sanitization, escaping and capability checks
- Translation-ready through WordPress.org / translate.wordpress.org

## Test without installing WordPress locally

1. Open [WordPress Playground](https://playground.wordpress.net/).
2. Package the plugin with the root folder `kalyvox-ai-receptionist-call-widget/`.
...
```bash
php -l kalyvox-ai-receptionist-call-widget.php
php -l uninstall.php
```
