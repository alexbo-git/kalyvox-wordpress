...
final class Kalyvox_AI_Receptionist {
	...
	const PAGE_SLUG = 'kalyvox-ai-receptionist-call-widget';
	...
	public static function enqueue_admin_assets( $hook_suffix ) {
		if ( 'settings_page_' . self::PAGE_SLUG === $hook_suffix ) {
			wp_enqueue_style( 'kalyvox-ai-receptionist-call-widget-admin', plugins_url( 'assets/css/admin.css', __FILE__ ), array(), self::VERSION );
		}
	}

	public static function enqueue_frontend_assets() {
		wp_enqueue_style( 'kalyvox-ai-receptionist-call-widget', plugins_url( 'assets/css/widget.css', __FILE__ ), array(), self::VERSION );
	}

	public static function render_floating_widget() {
		$options = self::get_options();
		if ( ! empty( $options['enabled'] ) && ! empty( $options['phone'] ) ) {
			echo wp_kses( self::get_button_markup( $options ), self::get_allowed_button_html() );
		}
	}
	...
	public static function render_shortcode( $atts ) {
		...
		$options['display'] = 'all';
		return wp_kses( self::get_button_markup( $options ), self::get_allowed_button_html() );
	}
